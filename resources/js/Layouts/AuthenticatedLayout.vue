...
import { Search, ClipboardList, Plus, Bell, Unlock } from 'lucide-vue-next' // ← agregado Unlock
        ...
        <div class="flex-1 min-w-0 flex flex-col">
            <header
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="h-16 flex items-center justify-between gap-3">
                        ...
                        <div class="hidden sm:flex items-center gap-2">
                            ...
                            <!-- Liberaciones (acceso rápido en topbar) -->
                            ...
                            <Dropdown align="right" width="56">
                                <template #trigger>
                                    ...
                                    >
                                        ...
                                        <svg class="-me-0.5 ms-1 h-4 w-4 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                                            <path
                                                fill-rule="evenodd"
                ...
                <div class="md:hidden" :class="showingNavigationDropdown ? 'block' : 'hidden'">
                    ...
                    <div class="px-4 pb-3 grid grid-cols-1 sm:grid-cols-3 gap-2">
                        <Link :href="route('mis.asignaciones')" class="col-span-1">
                            <button class="w-full rounded-lg border bg-white py-2 text-sm">Mis asignaciones</button>
                        </Link>

                        <!-- Liberaciones en menú móvil -->
                        <Link :href="route('liberaciones.index')" class="col-span-1">
                            <button class="w-full rounded-lg border bg-white py-2 text-sm">Liberaciones</button>
                        </Link>

                        <Link :href="route('creditos.create')" class="col-span-1">
